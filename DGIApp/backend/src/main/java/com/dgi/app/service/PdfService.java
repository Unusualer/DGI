...
public class PdfService {
    ...
    public byte[] generateRequestReceipt(Request request) throws IOException {
        ...
        try {
            ...
            String formattedDate = request.getDateEntree() != null ? request.getDateEntree().format(dateFormatter)
                    : "N/A";
            ...
            addTableRow(table, "Numéro d'identification:", String.valueOf(request.getId()), bodyFont);
            ...
            addTableRow(table, "Type:", request.getPmPp(), bodyFont);
            addTableRow(table, "CIN:", request.getCin() != null ? request.getCin() : "N/A", bodyFont);
            addTableRow(table, "IF:", request.getIfValue() != null ? request.getIfValue() : "N/A", bodyFont);
